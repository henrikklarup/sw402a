...
The commands in the action interpreter are simple. One of which is the \texttt{move}-command, e.g. \texttt{12 move 1,2}, which would move the unit with ID \texttt{12} to the coordinate \texttt{1,2}.
\\
