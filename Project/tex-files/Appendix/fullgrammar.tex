...
numeric-expression ::= primary-expression operator primary-expression | 
primary-expression operator-expression | 
parent-expression operator primary-expression | 
...
input ::= variable | identifier | input, variable | input, identifier | 
...
starters[[input]] ::= starters[[letter]] | starters[[num]] | 
...
parent-expression ::= ( numeric-expression )
numeric-expression ::= 
(primary-expression | parent-expression)+ operator (primary-expression | expression)+
primary-expression ::= number | identifier | boolean
