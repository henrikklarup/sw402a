    ...
    class DecorationVisitor
    {
        ...
        internal object visitObjectDecleration(ObjectDeclaration objectDeclaration, object arg)
        {
            ...
            if (arg != null)
            {
                using (StreamWriter file = new StreamWriter(CodeGenerationPath, true))
                {
                    file.Write(_object.spelling.ToLower() + " " +
                        ident.ToLower() + " = new " + _object.spelling.ToLower() + "(");
                }
            }
            ...
            if (arg != null)
            {
                ...
                {
                    file.WriteLine("); ");
                    file.WriteLine(_object.spelling.ToLower() + "List.Add(" + ident.ToLower() + ");");
                }
            }
