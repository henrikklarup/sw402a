...
The first thing one needs to define when writing a program in MASSIVE is the main function. This is done by writing \texttt{Main([someNumber])} where \texttt{someNumber} is the maximum unitpoints, which are then divided equally between each team.
