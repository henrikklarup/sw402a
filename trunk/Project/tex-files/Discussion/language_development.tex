...
It might therefor have been beneficial to develop the compiler in a language using the functional paradigm, as a defining feature of these languages is that functions do not have side effects. 
This means that no function will ever alter existing data, it will only create new data, and there would not be bugs of kind described above.