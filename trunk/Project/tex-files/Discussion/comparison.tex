...
We will in this section compare a C\# code example to the MASSIVE code example earlier in this chapter \ref{code:MASSIVE}. We assume that we have already created constuctors, functions, and an enviroment for the C\# code.
