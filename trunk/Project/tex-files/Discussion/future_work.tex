...
This actionpattern will be translated to the actionpattern, \texttt{unit encounter enemyPosition}, \rexttt{unit move someActionpattern}, which is the same as the current actionpatterns, but it will be more readable for the programmer if it is expanded with more states etc.
